...
class Admin {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'rank-math-pro-general-options', RANK_MATH_PRO_URL . 'assets/admin/js/general-options.js', [ 'wp-hooks' , 'lodash', 'jquery', 'wp-i18n', 'wp-api-fetch' ], rank_math_pro()->version, true );
