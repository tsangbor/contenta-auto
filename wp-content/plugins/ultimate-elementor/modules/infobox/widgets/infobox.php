...
class Infobox extends Common_Widget {
	...
	public function render_link( $settings ) {
		...
		if ( 'link' === $settings['infobox_cta_type'] ) {
			...
			$this->add_render_attribute( 'wrapper', 'class', 'uael-button-wrapper elementor-widget-button' );
	...
	protected function content_template() {
		...
		function render_link() {
			...
			<# }
				...
				view.addRenderAttribute( 'wrapper', 'class', 'uael-button-wrapper elementor-widget-button' );
