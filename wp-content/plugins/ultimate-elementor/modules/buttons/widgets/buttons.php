		...
		<div class="uael-dual-button-outer-wrap">
			<div class="uael-dual-button-wrap">
				...
				for ( $i = 0; $i < $count; $i++ ) :
					...
					$this->add_render_attribute( 'button_wrap_' . $i, 'class', 'uael-button-wrapper uael-dual-button elementor-widget-button' );
				...
				<#
					...
					if ( settings.buttons ) {
						...
						view.addInlineEditingAttributes( buttonContentKey, 'advanced' );
							...
							var icon_align = '';
				#>
				<div class="uael-button-wrapper uael-dual-button elementor-widget-button {{ button_wrap }}">
