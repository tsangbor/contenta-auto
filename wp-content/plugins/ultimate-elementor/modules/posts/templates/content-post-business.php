		...
		<?php $this->render_featured_image(); ?>
			...
			<div class="uael-post__content-wrap uael-content-wrap-<?php echo esc_attr( $button_class ); ?>">
				...
				if (
					...
					?>
					<div class="uael-post__terms-wrap"><?php $this->render_terms( $this->get_instance_value( 'terms_position' ) ); ?></div>
					<?php
				}
				if ( 'above_content' === $this->get_instance_value( 'terms_position' ) ) {
					?>
					<div class="uael-post__terms-wrap"><?php $this->render_terms( 'above_content' ); ?></div>
					<?php
				}
				...
				if ( $is_featured ) {
					...
					if ( 'yes' === $this->get_instance_value( 'show_excerpt' ) ) {
						$this->render_excerpt();
					}
				}
				...
				if ( 'yes' === $this->get_instance_value( 'show_authorbox_meta' ) ) {
					$this->render_authorbox();
				}
